...
var _ColumnViewDataSource = require('./ColumnViewDataSource');

var _ColumnViewDataSource2 = _interopRequireDefault(_ColumnViewDataSource);
 ...
 */
var ColumnView = (0, _autobindDecorator2.default)(_class = function (_React$Component) {
  _inherits(ColumnView, _React$Component);

  function ColumnView(props) {
    _classCallCheck(this, ColumnView);

    var _this = _possibleConstructorReturn(this, (ColumnView.__proto__ || Object.getPrototypeOf(ColumnView)).call(this, props));

    _this.columnViewId = (0, _createId2.default)();
    _this.columns = [];
    _this.state = {
  ...
  _createClass(ColumnView, [{
    ...
    value: function updateDataSource(dataSource) {
      ...
      // otherwise wrap it.
      if (!(dataSource instanceof _ColumnViewDataSource2.default)) {
        dataSource = new _ColumnViewDataSource2.default(dataSource);
      }
    ...
    value: function onNavigate(stack) {
      ...
      this.forceUpdate(function () {
        ...
        var dom = _reactDom2.default.findDOMNode(_this2);
        if (dom) {
    ...
    value: function onColumnFocus(focusedColumnIndex, fn) {
      ...
      this.setState({ focusedColumnIndex: focusedColumnIndex }, fn);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
    ...
    value: function render() {
      ...
      var _props = this.props,
          _props$id = _props.id,
          id = _props$id === undefined ? this.columnViewId : _props$id,
      ...
      var _state = this.state,
          ...
          focusedColumnIndex = _state.focusedColumnIndex;

      var stack = dataSource.navigationStack;
      var detail = dataSource.getDetailItem();
      var detailNode = dataSource.getDetailNode();
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          className: (0, _classnames2.default)('spectrum-MillerColumns react-spectrum-MillerColumns', className) },
        ...
        detail && renderDetail && _react2.default.createElement(
          'div',
          {
            role: 'group',
...
ColumnView.propTypes = {
  ...
  renderDetail: _propTypes2.default.func,
  ...
  navigatedPath: _propTypes2.default.arrayOf(_propTypes2.default.object),
