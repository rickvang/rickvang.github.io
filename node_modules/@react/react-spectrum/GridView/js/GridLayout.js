...
var GridLayout = function (_BaseLayout) {
  ...
  _createClass(GridLayout, [{
    ...
    value: function validate() {
      ...
      var width = availableWidth - this.minSpace.width * Math.max(0, this.numColumns - 1);
      ...
      this.itemSize = new _collectionView.Size(itemWidth, itemHeight);
