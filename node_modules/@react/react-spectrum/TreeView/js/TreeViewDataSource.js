...
var TreeViewDataSource = (_class = function (_ArrayDataSource) {
  ...
  function TreeViewDataSource(dataSource) {
    ...
    var _this = _possibleConstructorReturn(this, (TreeViewDataSource.__proto__ || Object.getPrototypeOf(TreeViewDataSource)).call(this, [[]]));
    ...
    if (dataSource && typeof dataSource.on === 'function') {
      ...
      _this.endTransaction = _this.endTransaction.bind(_this);
  ...
  _createClass(TreeViewDataSource, [{
    ...
    key: 'getChildren',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(parent) {
    ...
    value: function collapseItem(item) {
      ...
      node.walk(function (child) {
        if (child.isVisible) {
          ...
          _get(TreeViewDataSource.prototype.__proto__ || Object.getPrototypeOf(TreeViewDataSource.prototype), 'removeItem', _this3).call(_this3, indexPath);
        }
      });
    ...
    value: function removeChild(parent, index) {
      ...
      if (parentItem.isExpanded) {
        ...
        child.isVisible = false;
        _get(TreeViewDataSource.prototype.__proto__ || Object.getPrototypeOf(TreeViewDataSource.prototype), 'removeItem', this).call(this, indexPath);

        // Remove all children
        if (child.isExpanded) {
          child.walk(function (child) {
            child.isVisible = false;
            _get(TreeViewDataSource.prototype.__proto__ || Object.getPrototypeOf(TreeViewDataSource.prototype), 'removeItem', _this4).call(_this4, indexPath);
          });
        }
    ...
    value: function moveChild(fromParent, fromIndex, toParent, toIndex) {
      ...
      var toVisibleIndex = this._findInsertionIndex(toItem.item, toIndex);
      ...
      if (fromItem.isExpanded && toItem.isExpanded) {
        ...
        _get(TreeViewDataSource.prototype.__proto__ || Object.getPrototypeOf(TreeViewDataSource.prototype), 'moveItem', this).call(this, fromVisibleIndex, toVisibleIndex);
      } else if (fromItem.isExpanded) {
        child.isVisible = false;
        _get(TreeViewDataSource.prototype.__proto__ || Object.getPrototypeOf(TreeViewDataSource.prototype), 'removeItem', this).call(this, fromVisibleIndex);
...
}(_collectionView.ArrayDataSource), (_applyDecoratedDescriptor(_class.prototype, 'reloadItem', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'reloadItem'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'insertChild', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'insertChild'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'removeItem', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'removeItem'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'moveItem', [_autobindDecorator2.default], Object.getOwnPropertyDescriptor(_class.prototype, 'moveItem'), _class.prototype)), _class);
