...
var GalleryLayout = function (_BaseLayout) {
  ...
  function GalleryLayout() {
    ...
    var _this = _possibleConstructorReturn(this, (GalleryLayout.__proto__ || Object.getPrototypeOf(GalleryLayout)).call(this));
     ...
     * @default 208
     */
    _this.idealRowHeight = options.idealRowHeight || DEFAULT_OPTIONS[cardSize].idealRowHeight;
  ...
  _createClass(GalleryLayout, [{
        ...
        try {
          for (var _iterator = partition[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            for (var _j = index; _j < index + row.length; _j++) {
              ...
              var width = Math.round(_ratio * ratios[_j]);
    ...
    value: function getDropTarget(point) {
      ...
      if (dropPosition === _collectionView.DragTarget.DROP_ON) {
        ...
        if (layoutInfo) {
          indexPath = new _collectionView.IndexPath(layoutInfo.section, layoutInfo.index);
