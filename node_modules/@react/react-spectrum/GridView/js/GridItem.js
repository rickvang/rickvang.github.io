  ...
  _createClass(GridItem, [{
    ...
    value: function focus() {
      ...
      if (typeof this.cell.focus === 'function') {
        ...
        _reactDom2.default.findDOMNode(this.cell).focus();
      }
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { role: 'row', className: 'react-spectrum-GridView-item', 'aria-rowindex': layoutInfo.index + 1 },
        _react2.default.cloneElement(this.props.children, {
          ref: function ref(cell) {
            return _this2.cell = cell;
          },
          role: 'gridcell',
          tabIndex: tabIndex,
